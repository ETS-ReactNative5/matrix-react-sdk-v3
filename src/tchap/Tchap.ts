...
export default class Tchap {
     ...
     */
    static getDomainFromId(id: string): string {
     ...
     * @returns {string} The extracted domain name.
     */
    static getLongDomainFromId(id: string): string {
     ...
     * @returns {Promise}
     */
    static getHSInfoFromEmail(email: string): Promise<any> {
     ...
     * @returns {Promise}
     */
    static discoverPlatform(email: string) {
        const hostBase = TchapApi.hostBase;
        const infoUrl = TchapApi.infoFromEmailUrl;
     ...
     * @returns {string}
     */
    static getRandomHSUrlFromList(): string {
        const hostBase = TchapApi.hostBase;
     ...
     * @returns {Promise<*>}
     */
    static isUserExpired(userId: string): Promise<any> {
     ...
     * @returns {boolean}
     */
    static isCurrentUserExtern(): boolean {
     ...
     * @returns {boolean}
     */
    static isUserExternFromServer(hs: string): boolean {
     ...
     * @returns {boolean}
     */
    static isUserExternFromServerHostname(hs: string): boolean {
        return hs.includes('e.') || hs.includes('externe.');
    }
     ...
     * @returns {boolean}
     */
    static isUserExtern(userId: string): boolean {
        if (userId) {
     ...
     * @returns {boolean}
     */
    static looksLikeMxId(str: string): boolean {
     ...
     * @returns {string}
     */
    static computeLongRoomNameFromRoom(room: Room): string {
     ...
     * @returns {string}
     */
    static computeDomainFromRoomId(roomId: string): string {
     ...
     * @returns {*}
     */
    static computeDisplayNameFromUserId(userId: string): string {
        let dn = "";
     ...
     */
    static lookupThreePid(medium: string, address: string): Promise<any> {
        const homeserverUrl = MatrixClientPeg.get().getHomeserverUrl();
     ...
     * @returns {boolean}
     */
    static isUserLastAdmin(room: Room): boolean {
     ...
     * @returns {boolean}
     */
    static isRoomForum(roomId: string): boolean {
     ...
     */
    static getAccessRules(roomId: string): string {
     ...
     */
    static getJoinRules(roomId: string): string {
     ...
     * @returns {*}
     */
    static getExistingRoom(myUserId: string, userId: string): object {
    ...
    * @returns {boolean}
    */
    static isRoomNotice(room: Room): boolean {
     ...
     * @returns {*}
     */
    static transformServerErrors(str: string, short: boolean = false): string {
     ...
     * @returns {string|null}
     */
    static imgUrlToUri(url: string): string {
     ...
     * @private
     */
    static _httpRequest(url: string, opts: any): Promise<any> {
        const options = opts || {};
